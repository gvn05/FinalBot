...
const FACEBOOK_ACCESS_TOKEN = 'EAAKfsoZCXAxEBACaZBvRr8PX0DiUyqOCs4eeqsBX6wTryrFEoWkE8pHJW6cRtQpQNOiHAeocx0XGwssalONYax73Ail2ZC5p4J3idGFMZA3xkWDpMp9ubpUBaxGQLqz8rFtv36mrpsaZBXJVu46jMjoYEAjC0DpNCszegFZB0O5AZDZD';

var FBMessenger = require('fb-messenger');
var messenger = new FBMessenger(FACEBOOK_ACCESS_TOKEN);

const PAGE_ID = "511973805856834";
const ngrok = "https://c8085542.ngrok.io";
...
payloadFb.prototype.sendListMessage =function (senderId) {
    var messageData = {
        recipient: {
            id: senderId
        },
        message: {
            attachment: {
                    ...
                    "buttons": [
                {
                    ...
                    "type": "web_url",
                    "url": "https://www.movistar.com.ec/atencion-cliente"                        
                }
            ]  
                }
            }
...
const list = [
                            {
                                "title": "¿Qué puedo hacer desde Mi Movistar?",
                                "image_url": "http://www.elboletin.com/fotos/1/mi-movistar-d.jpg",
                                "buttons": [
                                    {
                                        "title": "Ver más",
                                        "type": "web_url",
                                        "url": "https://www.movistar.com.ec/productos-y-servicios/apps/mi-movistar-movil",
                            ...
                            {
                                "title": "¿Cuáles son los números de consulta?",
                                "image_url": "https://www.movistar.com.ec/documents/10184/23292/D_numeros_llamar.png/c01bd24d-44c4-467e-9dae-e3d92735945c?t=1435069966653",
                                "buttons": [
                                    {
                                        "title": "Ver más",
                                        "type": "web_url",
                                        "url": "https://www.movistar.com.ec/atencion-cliente/numeros-de-consulta",
                                        "messenger_extensions": true,
                                        "webview_height_ratio": "tall"
                        }
                    ]
                            ...
                            {
                                "title": "¿Dónde puedo pagar mi factura?",
                                "image_url": "http://jubiladosags.com.mx/wp/wp-content/uploads/2016/11/pagos.png",
                                "buttons": [
                                    {
                                        "title": "Ver más",
                                        "type": "web_url",
                                        "url": "https://www2.movistar.com.ec/site/atencion-al-cliente/puntos-de-pago.html",
                                        "messenger_extensions": true,
                                        "webview_height_ratio": "tall"
                        }
                    ]
...
payloadFb.prototype.sendAction = function (senderId) {
...
payloadFb.prototype.checkWhiteList = function (senderId) {
    request({
        ...
        json: {
            ...
            "whitelisted_domains": [ngrok, "https://www.movistar.com.ec/","https://www.movistar.com.ec/productos-y-servicios/apps/mi-movistar-movil","https://www2.movistar.com.ec/site/atencion-al-cliente/puntos-de-pago.html","https://www.movistar.com.ec/atencion-cliente/numeros-de-consulta","https://www.movistar.com.ec/atencion-cliente"],
